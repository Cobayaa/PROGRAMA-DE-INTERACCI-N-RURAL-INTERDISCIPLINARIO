          ...
          <div className="hidden md:flex md:items-center md:gap-8">
            {navLinks.map((link) => (
              <Link
                key={link.name}
                to={link.path}
                className="text-gray-700 hover:text-black text-base font-normal tracking-wide transition-colors duration-200 py-2 border-b-2 border-transparent hover:border-gray-400"
              >
                {link.name}
              </Link>
            ))}
